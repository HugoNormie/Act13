...
export const Router = createBrowserRouter([
	{
		...
		children: [
          ...
          { path: "tipoSesion", element: <SessionCollections /> },
          { path: "Sesion_Productos", element: <SessionProductCollections /> },
          { path: "Productos", element: <ProductCollections /> },
          { path: "Direccion", element: <DirectionCollections /> },
          { path: "Genero", element: <GenderCollections /> },
